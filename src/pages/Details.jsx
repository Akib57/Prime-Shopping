...
const Details = () => {
    ...
    return (
        <div>
            <Headers />
            <div className='bg-[url("https://prime-shopping-roan.vercel.app/images/banner/order.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                            ...
                            <div className='flex py-5 gap-5'>
                                ...
                                <div className='flex flex-col gap-5'>
                                    ...
                                    <ul className='flex justify-start items-center gap-3'>
                                        <li>
                                            <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-indigo-500 rounded-full text-white' href="https://www.facebook.com"><FaFacebookF /></a>
                                        </li>
                                        <li>
                                            <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-cyan-500 rounded-full text-white' href="https://twitter.com/?partner=opera15-other"><AiOutlineTwitter /></a>
                                        </li>
                                        <li>
                                            <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-purple-500 rounded-full text-white' href="https://www.linkedin.com"><FaLinkedin /></a>
                                        </li>
                                        <li>
                                            <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-blue-500 rounded-full text-white' href="https://github.com/Akib57"><AiFillGithub /></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
