    ...
    return (
        <footer className='bg-[#F3F6Fa]'>
            <div className='w-[85%] flex flex-wrap mx-auto border-b py-16 md-lg:pb-10 sm:pb-6'>
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        <img className='w-[190px] h-[70x]' src="https://prime-shopping-roan.vercel.app/images/logo.png" alt="logo" />
                        <ul className='flex flex-col gap-2 text-slate-600'>
                            <li>Address : Navaron Rail Bazar, Jashore </li>
                            <li>Mobile No : +8801521-515536</li>
                            <li>Email : akib.mohiuddin@gmail.com</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className='w-4/12 lg:w-full lg:mt-6'>
                    <div className='w-full flex flex-col justify-start gap-5'>
                        <h2 className='font-bold text-lg mb-2'>Join Our Community</h2>
                        ...
                        <ul className='flex justify-start items-center gap-3'>
                            <li>
                                <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-white rounded-full' href="https://www.facebook.com/mohiuddin.akib/"><FaFacebookF /></a>
                            </li>
                            <li>
                                <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-white rounded-full' href="https://www.facebook.com/mohiuddin.akib/"><AiOutlineTwitter /></a>
                            </li>
                            <li>
                                <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-white rounded-full' href="https://www.linkedin.com/in/mohiuddin-al-faruki-akib-440a18218/"><FaLinkedin /></a>
                            </li>
                            <li>
                                <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-white rounded-full' href="https://github.com/Akib57"><AiFillGithub /></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div className='w-[85%] flex flex-wrap justify-center items-center text-slate-600 mx-auto py-5 text-center'>
                <span>Copyright © 2024 All rights reserved By | <a className='text-blue-500 underline' href="https://www.facebook.com/mohiuddin.akib/">Mohiuddin Al Faruki Akib</a></span>
            </div>
