                    ...
                    <div className='flex w-full justify-between items-center h-[50px] text-slate-500'>
                        <ul className='flex justify-start items-center gap-8'>
                            <li className='flex relative justify-center items-center gap-2 text-sm after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px]'>
                                <span><GrMail /></span>
                                <span>akib.mohiuddin@gmail.com</span>
                            </li>
                            <span> Prime Shopping </span>
                        </ul>
                        <div>
                            <div className='flex justify-center items-center gap-10'>
                                <div className='flex justify-center items-center gap-4'>
                                    <a href="https://www.facebook.com/mohiuddin.akib/"><FaFacebookF /></a>
                                    <a href="https://www.facebook.com/mohiuddin.akib/"><AiOutlineTwitter /></a>
                                    <a href="https://www.linkedin.com/in/mohiuddin-al-faruki-akib-440a18218/"><FaLinkedinIn /></a>
                                    <a href="https://github.com/Akib57"><AiFillGithub /></a>
                                </div>
                    ...
                    <div className='flex justify-start flex-col gap-6'>
                        ...
                        <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                            ...
                            <div className='flex justify-end flex-col gap-1'>
                                <h2 className='text-sm font-medium text-slate-700'>+8801521-515536</h2>
                        ...
                        <ul className='flex flex-col justify-start items-start gap-3 text-[#1c1c1c]'>
                            ...
                            <span className='text-sm'> Prime Shopping </span>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div className='flex flex-wrap w-full justify-between items-center md-lg:gap-6'>
                            <div className='w-8/12 md-lg:w-full'>
                                <div className='flex border h-[50px] items-center relative gap-5'>
                                    ...
                                    <input className='w-full relative bg-transparent text-slate-500 outline-0 px-3 h-full' onChange={(e) => setSearchValue(e.target.value)} type="text" name="" id="" placeholder='Hi! What do you need? ' />
                            ...
                            <div className='w-4/12 block md-lg:hidden pl-2 md-lg:w-full md-lg:pl-0'>
                                <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                                    ...
                                    <div className='flex justify-end flex-col gap-1'>
                                        <h2 className='text-md font-medium text-slate-700'>+8801521-515536</h2>
